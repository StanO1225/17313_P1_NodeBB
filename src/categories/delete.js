    ...
    Categories.purge = function (cid, uid) {
        return __awaiter(this, void 0, void 0, function* () {
            yield batch_1.default.processSortedSet(`cid:${cid}:tids`, (tids) => __awaiter(this, void 0, void 0, function* () {
                yield async_1.default.eachLimit(tids, 10, (tid) => __awaiter(this, void 0, void 0, function* () {
                    // The next line calls a function in a module that has not been updated to TS yet
                    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access,@typescript-eslint/no-unsafe-call
            ...
            yield async_1.default.eachLimit(pinnedTids, 10, (tid) => __awaiter(this, void 0, void 0, function* () {
                // The next line calls a function in a module that has not been updated to TS yet
                // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call
                yield topics_1.default.purgePostsAndTopic(tid, uid);
            }));
            ...
            plugins_1.default.hooks.fire('action:category.delete', { cid: cid, uid: uid, category: categoryData });
        });
    };
